...
public class Task3 {
    ...
    public static void isOnSameLine() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter A coordinates x then y: ");
        x1 = scanner.nextInt();
        y1 = scanner.nextInt();

        System.out.println("Enter B coordinates x then y: ");
        x2 = scanner.nextInt();
        y2 = scanner.nextInt();

        System.out.println("Enter C coordinates x then y: ");
        x3 = scanner.nextInt();
        y3 = scanner.nextInt();
